...
def print_stats(_current_requests_delay):
    ...
    print(f"{GRAY}{equals_line}{RESET}")
    print(f"{GRAY}{formatted_elapsed_time} | {round(1/_current_requests_delay, 3)} reqs/s | {consecutive_no_rate_limit} sCReqs | HTTPX? {USE_HTTPX} | {BATCH_SIZE}UIDs/Url{RESET}")
    print(f"{GRAY}{equals_line}{RESET}")
